...
const InfoBackground = (props: InfoBackgroundProps) => {
  ...
  const { isLoggedIn, lastLoginAt, name, avatarLink, backgroundLink, role, email, id, intro } = useSelector((state: RootState) => state.user);
      ...
      <div className="info-container">
        <div className="info">
          ...
          <div className="info-combo">
            ...
            {isLoggedIn &&
            (<p>{isSelf ? InfoBackgroundType.USER : infoType} id: {id} email: {email} 
