...
const ProfileDialog = ({ onClose }: ProfileDialogProps) => {
                    ...
                    Msg.confirm(
                        `Here are your invite codes:\n ${res.data
                            .map(item => {
                                ...
                                return diff > 0
                                    ? `${item.code} (used ${item.usedCount}/${item.maxCount} expired at ${diff} days)`
                                    : `${item.code} (expired)`;
                            })
                            .join('\n')}.`
                    );
    ...
    return (
        <PopUpDialogBase title={t('profileDialog.title')} onClose={onClose} bottomBtns={bottomBtns}>
                ...
                <div className='profile-dialog-container'>
                    ...
                    <div className='background-view' onError={handleImgBackgroundError}>
                        ...
                        <div className='info-card'>
                            <img
                                src={showState.avatarLink}
                                alt='avatar'
                                onError={handleImgAvatarError}
                            />
                            <div className='combination'>
                                <h4>
                                    ...
                                    <span
                                        style={{
                                            background:
                                                showState.role == UserType.ADMIN
                                                    ? 'var(--primary)'
                                                    : showState.role == UserType.USER
                                                      ? 'var(--secondary-warm-1)'
                                                      : 'var(--secondary-cool)',
                                        }}
                                    >
                                        {showState.role}
                                ...
                                <p>
                                    id : {showState.id} email : {showState.email}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <p>
                        ...
                        <input
                            type='text'
                            placeholder={t('profileDialog.rolePlaceholder')}
                            name='role'
                            id='role'
                            defaultValue={showState.role}
                            disabled
                        />
                    </p>
                    <p>
                        ...
                        <input
                            type='text'
                            placeholder={t('profileDialog.emailPlaceholder')}
                            name='email'
                            id='email'
                            defaultValue={showState.email}
                            disabled
                        />
                    </p>
                    <p>
                        <label htmlFor='introduction'>{t('profileDialog.introduction')}</label>
                    </p>{' '}
                    <textarea
                        placeholder={t('profileDialog.introductionPlaceholder')}
                        name='introduction'
                        id='introduction'
                        defaultValue={showState.intro}
                    ></textarea>
                    {/* 背景和头像编辑区域 */}
                    ...
                    <p>
                        <label htmlFor='oldPassword'>{t('profileDialog.oldPassword')}</label>{' '}
                        <input
                            type='password'
                            placeholder={t('profileDialog.oldPasswordPlaceholder')}
                            name='oldPassword'
                            id='oldPassword'
                            ref={oldPasswordRef}
                        />
                    ...
                    <p>
                        <label htmlFor='newPassword'>{t('profileDialog.newPassword')}</label>{' '}
                        <input
                            type='password'
                    ...
                    <button onClick={changePassword}>
                        {t('profileDialog.changePasswordButton')}
                    </button>
                    {/* 邀请码区域*/}
