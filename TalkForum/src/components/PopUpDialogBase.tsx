...
const PopUpDialogBase: React.FC<PopUpDialogBaseProps> = ({
    ...
    return (
        <div className='popup-dialog-base-cover' style={style}>
            <div
                ref={containerRef}
            ...
            >
                ...
                {toolBox && <div className='popup-dialog-base-toolbox'>{toolBox}</div>}
                ...
                {(footerLeft || bottomBtns.length > 0) && (
                    <div className='popup-dialog-base-footer'>
                        {/* 底部左侧内容：如"#Club"选择器 */}
                        {footerLeft && (
                            <div className='popup-dialog-base-footer-left'>{footerLeft}</div>
                        )}
                        {/* 底部右侧按钮组 */}
                        {bottomBtns.length > 0 && (
