...
const PrivacyDialog: React.FC<PrivacyDialogProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <PopUpDialogBase title='TalkForum Privacy Policy' onClose={onClose} showCloseIcon={true}>
            <div className='privacy-dialog-content'>
                <h3>1. Information We Collect</h3>
                <p>
                    We collect information you provide directly to us, such as when you create an
                    account, post content, or communicate with us. This may include your name, email
                ...
                <p>
                    ...
                    parties without your consent, except as described in this privacy policy. We may
                ...
                <p>
                    ...
                    may also object to processing of your personal information, ask us to restrict
                    processing of your information, or request portability of your information.
                </p>
