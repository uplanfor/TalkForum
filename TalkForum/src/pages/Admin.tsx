        ...
        <div className='admin-container'>
            <h1 className='admin-header'>
                <div className='admin-menu-toggle'>
                    {isMenuOpen ? (
                        <XMarkIcon className='menu-toggle' onClick={toggleMenu} />
                    ) : (
                        <Bars3Icon className='menu-toggle' onClick={toggleMenu} />
                    )}
                </div>
            ...
            <div className='admin-view'>
                ...
                <div className='admin-content'>{menuItems[curIndex].component}</div>
            </div>
        </div>
    ) : (
        <NotFound />
