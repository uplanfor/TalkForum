...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '圈子表（储存所有的圈子；用户删除时圈子软删掉，变为不可加入）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '圈子创建申请表（记录所有圈子申请记录，申请人删除时级联删除申请；处理人删除时保留申请）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '圈子加入申请表（记录圈子加入记录，申请人删除时级联删除申请；圈子删除时级联删除申请；处理人删除时保留申请）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '圈子成员表（查询圈子所有成员，圈子删除时级联删除成员关系；用户删除时级联删除成员关系）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '通知表（记录通知信息，接收用户删除时级联删除通知；操作人删除时移除通知）' ROW_FORMAT = Dynamic;
...
INSERT INTO `post` VALUES (10, '做好预习工作！', '下两周高效预习无机化学以面对期末考试', '下两周高效预习无机化学以面对期末考试', 2, NULL, 'PASS', 1, '2025-12-11 16:52:55', '2025-12-21 10:39:43', 2, 1, 0, NULL, '励志故事', '', '');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'master@talkforum.top', '$2a$10$7Zro1CH4qUKMSTy9QeeNNOJWas8vY8.qlPn73EO77GK35DfB5zxy.', 'lichi', 'ADMIN', 0, 0, 'Hello~', '2025-12-08 22:03:18', '2025-12-21 11:38:09', 'NORMAL', 'https://pic1.imgdb.cn/item/6905cbca3203f7be00bf6e33.webp', 'https://img-s.msn.cn/tenant/amp/entityid/BB1msDBR?w=0&h=0&q=50&m=6&f=jpg&u=t', NULL);
